...
const levels = [
  // Aufgabe 1: Vektoren
  {
    id: "task1_vectors",
      ...
      {
        id: "task1_task_a",
        question: "a) Bestimmen Sie den Vektor \\(\\vec{PQ} = \\begin{pmatrix} x_1 \\\\ x_2 \\end{pmatrix}\\)",
        type: "vector",
        answer: { values: [4, 3] },
        difficulty: 1
      },
      {
        id: "task1_task_b",
        question: "b) Bestimmen Sie den Vektor \\(\\vec{PQ} = \\begin{pmatrix} x_1 \\\\ x_2 \\end{pmatrix}\\)",
        type: "vector",
        answer: { values: [-4, 4] },
        difficulty: 1
      },
      {
        id: "task1_task_c",
        question: "c) Bestimmen Sie den Vektor \\(\\vec{PQ} = \\begin{pmatrix} x_1 \\\\ x_2 \\\\ x_3 \\end{pmatrix}\\)",
        type: "vector",
        answer: { values: [2, 0, 4] },
        difficulty: 1
      },
      {
        id: "task1_task_d",
        question: "d) Bestimmen Sie den Vektor \\(\\vec{PQ} = \\begin{pmatrix} x_1 \\\\ x_2 \\\\ x_3 \\end{pmatrix}\\)",
        type: "vector",
        answer: { values: [-1, 2, -5] },
        difficulty: 1
      }
